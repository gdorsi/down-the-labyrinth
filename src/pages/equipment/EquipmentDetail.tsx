...
export function EquipmentDetail() {
  ...
  useEffect(() => {
    // When equipmentId changes, open the drawer
    setIsOpen(true)
  }, [equipmentId])
  ...
  const equipment = me.root.game.equipment[equipmentId]

  if (!equipment) {
    return (
      <div className="text-center py-12">
        <h2 className="text-2xl font-bold text-gray-700">Equipment not found</h2>
        <Button onClick={() => navigate({ to: "/equipment" })} className="mt-4">
          Back to Equipment
        </Button>
      </div>
    )
      ...
      <DrawerContent className="h-[90vh] max-h-[90vh] sm:max-h-[85vh]">
        <DrawerHeader className="border-b">
          <div className="flex items-center justify-between">
            <DrawerTitle className="text-xl sm:text-2xl">Edit Equipment</DrawerTitle>
            <DrawerClose asChild>
          ...
          <DrawerDescription className="hidden sm:block">Make changes to your equipment here.</DrawerDescription>
        </DrawerHeader>
        ...
        <div className="overflow-y-auto p-3 sm:p-4 pb-16">
                ...
                <CardContent className="pt-4 sm:pt-6">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="space-y-1 sm:space-y-2">
                      ...
                      <Input id="name" value={equipment.name} onChange={(e) => (equipment.name = e.target.value)} />
                    </div>
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) => (equipment.description = e.target.value)}
                        rows={3}
                      />
                    </div>
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => (equipment.type = value as "weapon" | "armor" | "artifact")}
                      >
                        <SelectTrigger>
          ...
          <Card className="mt-4 sm:mt-6">
            <CardContent className="pt-4 sm:pt-6">
              ...
              <AbilitySelector currentAbilityIds={Object.keys(equipment.abilities)} onAddAbility={handleAddAbility} />
            </CardContent>
          </Card>
        </div>
        ...
        <DrawerFooter className="border-t">
          <div className="flex flex-col sm:flex-row sm:justify-between w-full gap-2 sm:gap-0">
            <Button variant="destructive" onClick={handleDeleteEquipment} className="order-2 sm:order-1">
              Delete Equipment
            </Button>
